...
final fruits = [
  Fruit(
      title: "Blueberry",
      headline:
          "Blueberries are sweet, nutritious and wildly popular fruit all over the world.",
      image: "blueberry",
      gradientColors: [
        ColorBlueberryLight,
        ColorBlueberryDark
...
""",
  ...
  Fruit(
      ...
      image: "pomegranate",
      gradientColors: [
        ColorPomegranateLight,
        ColorPomegranateDark
      ],
      description: """
